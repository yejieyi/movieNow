...
function loadWatchList(data) {
    $('.watchlist').empty();
    $.each(data, function (key, watchlist) {
        console.log(data);
        $.ajax({
            url: 'https://api.themoviedb.org/3/movie/' + watchlist.movieid + '?api_key=343f078c30e5ffe3c08cc3da703c7633&language=en-US',
            method: 'get'
